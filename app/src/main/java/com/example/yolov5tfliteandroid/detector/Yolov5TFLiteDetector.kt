...
class Yolov5TFLiteDetector {
    ...
    private val MODEL_YOLOV5S = "test_best_cpu.tflite"
...
//            }
        ...
        Log.i("tfliteSupport", "recognize data size: " + nmsFilterBoxDuplicationRecognitions.size)
...
//                if (allRecognitions.get(j).getLabelId() == i) {
    ...
    protected fun boxIou(a: RectF, b: RectF): Float {
        ...
        return if (union <= 0) 1 else intersection / union
    }
